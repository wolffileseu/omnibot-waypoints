...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.72d9c97cf0293efff2bfff08efbfda82add3963fa21220e807b1428fbbd4a388.js',function(){input.required=false;search();});}
